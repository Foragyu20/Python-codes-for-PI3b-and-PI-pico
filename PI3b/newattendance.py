...
log_file_path = "/home/Gubatzx/Desktop/rfid_logs.txt"
...
while True:
    try:
        ...
        # Save ID, text, and current date and time to the log
        with open(log_file_path, "a") as file:
            file.write(f"Date and Time: {current_time}, ID: {id}, Text: {text}\n")

        # Display the text on the LCD
        lcd.clear()
        lcd.display_line("ID:" + str(id), 1)
        lcd.display_line("Text: " + text, 2)
